...
class PollCog(commands.Cog):
    ...
    async def create_poll(self, ctx, question: Option(str, description='Question in poll', required=True, default=''),
                          number_of_answers: Option(int, description='Number of answers', required=True, min_value=2,
                                                    max_value=5),
                          lifetime: Option(int, description='Lifetime of poll in seconds(by default 180 seconds)', required=False, min_value=30,
                                           default=180),
                          text: Option(str,
                          ...
                          result_channel: Option(discord.TextChannel,
                                                 ...
                                                 required=False, default=None),
                          anonymous: Option(bool, description='If True author of poll wouldnt be shown(by default False)',
